...
contract("CUTTIES", async (accounts) => {
  ...
  describe("Mint CUTTIES", () => {
    beforeEach(async () => {
      instance = await Cutties.new("", { from: deployer });
    });

    it("Mint Cutties", async () => {
      ...
      await instance.mintCutties(referee, amount.toString(10), ZERO_ADDRESS, {
        from: referee,
      ...
      await instance.mintCutties(referrer, amount.toString(10), referee, {
        from: referrer,
        value: ethValue.toString(10)
      });
